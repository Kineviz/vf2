(function (global, factory) {
    ...
    var Edge = /** @class */ (function () {
        function Edge(label, source, target) {
            this.source = source;
            this.target = target;
            this.label = label;
    ...
    var Graph = /** @class */ (function () {
        ...
        Graph.prototype.addEdge = function (id, label, source, target) {
    ...
    var VF2Matcher = /** @class */ (function () {
            ...
            if (s.depth == patternGraph.nodes.size) {
                ...
                candiatePairs_1.forEach(function (v, n) {
                    ...
                    if (_this.checkFeasibility(s, n, m)) {
                        ...
                        _this.matchInternal(s, modelGraph, patternGraph); // recursive call
        ...
        VF2Matcher.prototype.checkRin = function (s, n, m) {
            ...
            s.modelGraph.getInComingingVertices(m).forEach(function (id) {
                T2in.delete(id);
            });
